...
import 'package:hello_world/screens/homeTutor/tutor_sidebar.dart';
...
void main() => runApp(new SignInTutor());
String email = '';

class SignInTutor extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return new MaterialApp(
      title: 'Login',
      debugShowCheckedModeBanner: false,
      home: new SignInPageTutor(),
      routes: <String, WidgetBuilder>{
        "/tutordrawer": (BuildContext context) => new TutorDrawer(
              email: email,
            ),
...
class SignInPageTutor extends StatefulWidget {
  final Function toggleView;
  SignInPageTutor({this.toggleView});

  @override
  _SignInPageTutorState createState() => _SignInPageTutorState();
}

class _SignInPageTutorState extends State<SignInPageTutor> {
